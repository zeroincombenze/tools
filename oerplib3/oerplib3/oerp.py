...
from oerplib3 import rpc, error, tools
from oerplib3.tools import session, v
from oerplib3.service import common, db, wizard, osv, inspect
...
class OERP(object):
    ...
    def list(cls, rc_file='~/.oerplibrc'):
        ...
        return [name for name, data in sessions.items()
                if data.get('type') == cls.__name__]
