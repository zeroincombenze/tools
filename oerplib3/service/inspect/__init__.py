...
class Inspect(object):
    ...
    def relations(self, models, maxdepth=1, whitelist=None, blacklist=None,
        ...
        from oerplib3.service.inspect.relations import Relations
        return Relations(
    ...
    def scan_on_change(self, models):
        ...
        """
        from oerplib3.service.inspect.on_change import scan_on_change
    ...
    def dependencies(self, modules=None, models=None, models_blacklist=None,
        ...
        from oerplib3.service.inspect.dependencies import Dependencies
        return Dependencies(
