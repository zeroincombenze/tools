...
RFLIST__python_plus=""
RFLIST__wok_code="cvt_csv_2_xml.py generate_all_tnl gen_addons_table.py makepo_it.py odoo_dependencies.py odoo_translation.py vfcp vfdiff wget_odoo_repositories.py"
