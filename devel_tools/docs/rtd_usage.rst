...
::
    ...
    i.e.  .. $if branch == '12.0'
          Current branch is 1.0.0.13

In above example then word branch after statement $if ia the VAR branch.
The word branch in the second line is a text. The item 1.0.0.13 is the macro, replaced by the value of varaibale branch.
...
Last Update / Ultimo aggiornamento: 2021-03-14
