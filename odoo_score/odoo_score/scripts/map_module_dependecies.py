        ...
        for modulename, module in self.module_map.items():
            ...
            for dep_name in module["depends"]:
                if dep_name not in self.module_map:
                    print("Module %s not found! It is required by %s" % (
                        dep_name, modulename))
                    continue
                ...
                if (
                    ...
                    and dep_reponame not in self.repositories[reponame][
                    "oca_dependencies"]
                ):
                     self.repositories[reponame]["oca_dependencies"].append(
                         dep_reponame)
            print(module)
        print("")
