...
RFLIST__clodoo="awsfw . clodoo.py inv2draft_n_restore.py list_requirements.py makepo_it.py manage_db manage_odoo manage_odoo.man odoo_install_repository odoorc oe_watchdog run_odoo_debug odoo_skin.sh set_odoover_confn transodoo.py transodoo.csv upd_oemod.py"
