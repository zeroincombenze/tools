...
REQVERSION = {
    ...
    "argparse": {"0": "==1.2.1"},
    "astroid": {
        # Version by test pkgs
        "2.7": "==1.6.5", "3.5": "==2.11.7", "3.7": ">=2.11.7,<=3.1.0"},
    "autopep8": {"0": "==1.2"},
    "Babel": {
        "6.1": "==1.3",
        "8.0": "==2.3.4",
    ...
    "ofxparse": {"6.1": "==0.16"},
    "pandas": {"0": ">=0.22.0,<=1.1.0", "3.7": ">=0.22.0,<=1.1.0", "3.8": ">=0.25.3"},
    "passlib": {
        "6.1": "==1.6.2", "10.0": "==1.6.5", "11.0": ">=1.6.5", "16.0": ">=1.7.0"
    },
...
def main(cli_args=None):
    ...
    if ctx["rpc_packages"]:
        if ctx["odoo_ver"] and int(ctx["odoo_ver"].split(".")[0]) <= 10:
            deps_list = package_from_list(
                deps_list,
                "python",
                RPC2_PACKAGES,
