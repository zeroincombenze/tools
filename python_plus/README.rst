...
==========================
|icon| python_plus 0.1.0.2
==========================


.. |icon| image:: https://raw.githubusercontent.com/zeroincombenze/tools/./python_plus/static/src/img/icon.png
...
::
    ...
    odoo_install_repository tools -b . -O zero
    for pkg in os0 z0lib; do
        pip install $pkg -U
    done
    sudo manage_odoo requirements -b . -vsy -o /opt/odoo/.
...
::
    ...
    odoo_install_repository tools -b . -O zero -U
...
<https://github.com/zeroincombenze/tools/issues>`_.
...
Last Update / Ultimo aggiornamento: 2019-06-24
