...
test_03() {
    ...
    #
    TRES="asn1crypto,'Babel>=2.3.4,<=2.9.1',certifi,chardet,configparser,'cryptography>=2.6.1,<38.0','decorator>=4.0.10',docutils==0.16,feedparser==5.2.1,future,gdata==2.0.18,'gevent>=1.5.0,<=21.12.0',html2text,idna,Jinja2==2.10.1,'lessc>=3.0.0','lxml>=4.2.3,<=4.6.5','Mako>=1.0.4','num2words>=0.5',numpy,'odoo_score>=2.0.0','passlib>=1.6.5','Pillow>=6.1.0,<=6.2.0','psutil>=4.3.1',psycogreen==1.0,'psycopg2-binary>=2.8.3',pyasn1,'pydot>=1.2.3','pyOpenSSL>=16.2.0,<19.0',pyparsing==2.1.10,'pyPDF2<2.0','pyPdf>=3.1.0','pyserial>=3.1.1',Python-Chart==1.39,python-dateutil==2.5.3,python-ldap==2.5.28,python-openid==2.2.5,python-plus,'python-stdnum>=1.8.1','pytz>=2016.7',reportlab==3.3.0,'simplejson>=3.5.3','six>=1.10.0',urllib3[secure],vatnumber==1.2,Werkzeug==0.14.1"
    RES=$(list_requirements.py -b12.0 -tpython -BSP)
    test_result "list_requirements -b12.0 -tpython -BSP" "$TRES" "$RES"
    #
    TRES="asn1crypto,'Babel>=2.6.0,<=2.9.1',certifi,chardet,configparser,'cryptography>38.0.2','decorator>=4.0.10',docutils==0.16,feedparser==5.2.1,future,gdata==2.0.18,'gevent>=20.9.0,<=22.10.99',html2text,idna,'Jinja2>=2.11.2,<=2.11.3','lessc>=3.0.0','lxml>=4.6.1,<=4.6.5','Mako>=1.0.4','matplotlib<3.3.0','num2words>=0.5',numpy,'odoo_score>=2.0.0','passlib>=1.7.0','pdfplumber<0.10.2','Pillow>=6.2.1','psutil>=4.3.1',psycogreen==1.0,'psycopg2-binary>=2.8.3',pyasn1,'pydot>=1.2.3','pyOpenSSL>=21.0.0,<23.0',pyparsing==2.1.10,'pyPDF2<3.0','pyPdf>=3.1.0','pyserial>=3.1.1',Python-Chart==1.39,'python-dateutil>=2.5.3','python-ldap>=3.1.0,<=3.4.4',python-openid==2.2.5,python-plus,'python-stdnum>=1.8.1','pytz>=2016.7','qrcode>=5.3','reportlab>=3.3.0','simplejson>=3.5.3','six>=1.10.0',urllib3[secure],vatnumber==1.2,Werkzeug==2.0.2,zeep==2.4.0"
