...
if __name__ == "__main__":
    parser = z0lib.parseoptargs(
        "upd_oemod", "© 2017 by SHS-AV s.r.l.", version=__version__
    )
    parser.add_argument("-h")
    parser.add_argument(
        "-b", "--branch", action="store", dest="oe_version", default="7.0"
    )
    parser.add_argument(
        "-c",
        "--config",
    ...
    parser.add_argument("-d", "--database", action="store", dest="opt_db")
