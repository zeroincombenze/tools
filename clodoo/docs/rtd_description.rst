...
+-------------+---------+--------------------+---------------------------------+------------------------------+-------------------------+
| db_user     | USER    | odoo               | odoo{major_version}             | odoo{major_version}          | i.e odoo11              |
+-------------+---------+--------------------+---------------------------------+------------------------------+-------------------------+
| config file | CONFN   | odoo[-server].conf | odoo{major_version}-server.conf | odoo{major_version}-oca.conf | Directory /etc/odoo     |
+-------------+---------+--------------------+---------------------------------+------------------------------+-------------------------+
